    ...
    return (
        <div className="about">
            <div className="left">
                <h1>About Me</h1>
                <p>
                    Pursuing B.Tech in Computer Science at Poornima University with a CGPA of 8.64
                    <br /> Skilled in Data Structures, Algorithms, Java, Python, JavaScript, React, and SQL.
